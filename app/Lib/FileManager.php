...
use Viserlab\Constants\FileInfo;
...
class FileManager
{
    ...
    */
	public function __construct($file = null){
		...
		if ($file) {
			...
			if (in_array(viser_request()->file($file)->extension, $imageExtensions) && !array_key_exists('direct_file',$this->file)) {
				$this->isImage = true;
			}else{
				$this->isImage = false;
			}
    ...
    */
	protected function getFileName(){
		return uniqid() . time() . '.' . viser_request()->file($this->file)->extension;
	}
