<script>
    class FormGenerator {
        ...
        extraFields(fieldType) {
                    ...
                    <option value="jpg"><?php esc_html_e('JPG',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="jpeg"><?php esc_html_e('JPEG',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="png"><?php esc_html_e('PNG',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="pdf"><?php esc_html_e('PDF',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="doc"><?php esc_html_e('DOC',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="docx"><?php esc_html_e('DOCX',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="txt"><?php esc_html_e('TXT',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="xlx"><?php esc_html_e('XLX',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="xlsx"><?php esc_html_e('XLXS',VISERLAB_PLUGIN_NAME) ?></option>
                    <option value="csv"><?php esc_html_e('CSV',VISERLAB_PLUGIN_NAME) ?></option>
                </select>`;
                        var title = `<?php esc_html_e('File Extensions',VISERLAB_PLUGIN_NAME) ?> <small class="text--danger">*</small> <small class="text-primary">(<?php esc_html_e('Separate each element by comma',VISERLAB_PLUGIN_NAME) ?>)</small>`;
                    } else {
                        ...
                        var title = `<?php esc_html_e('Add Options',VISERLAB_PLUGIN_NAME) ?>`;
                    }
    ...
    `;
        ...
        formEdit(element) {
            ...
            if (formItem.type == 'file') {
                html += `
            <div class="d-flex justify-content-between flex-wrap">
                <label><?php esc_html_e('File Extensions',VISERLAB_PLUGIN_NAME) ?> <small class="text--danger">*</small> <small class="text-primary">(<?php esc_html_e('Separate each element by comma',VISERLAB_PLUGIN_NAME) ?>)</small></label>
            </div>
            <div class="mt-2">
                <div class="form-group">
                    <select class="select2-multi-select" name="extensions" multiple>
                        ...
                        <option value="txt"><?php esc_html_e('TXT',VISERLAB_PLUGIN_NAME) ?></option>
                        <option value="xlx"><?php esc_html_e('XLX',VISERLAB_PLUGIN_NAME) ?></option>
                        <option value="xlsx"><?php esc_html_e('XLSX',VISERLAB_PLUGIN_NAME) ?></option>
                        <option value="csv"><?php esc_html_e('CSV',VISERLAB_PLUGIN_NAME) ?></option>
                    </select>
                </div>
            </div>
        ...
        `;
            ...
            jQuery('.generatorSubmit').text('<?php esc_html_e('Update',VISERLAB_PLUGIN_NAME) ?>');
        ...
        resetAll() {
            ...
            jQuery('.generatorSubmit').text('<?php esc_html_e('Add',VISERLAB_PLUGIN_NAME) ?>');
