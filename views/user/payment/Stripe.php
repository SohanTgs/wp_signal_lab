            ...
            <div class="col-md-8">
                <div class="custom--card card-deposit">
                    <div class="card-header">
                        <h5 class="card-title text-center"><?php esc_html_e('Stripe Payment', VISERLAB_PLUGIN_NAME); ?></h5>
                    </div>
                    <div class="card-body card-body-deposit">
                        ...
                        <form role="form" id="payment-form" method="<?php echo esc_attr($data->method) ?>" action="<?php echo esc_url($data->url) ?>">
                            <?php viser_nonce_field('ipn.stripe'); ?>
                            ...
                            <button class="btn btn--base btn-lg btn-block text-center w-100" type="submit"><?php esc_html_e('Pay Now', VISERLAB_PLUGIN_NAME); ?></button>
                        </form>
